...
*/
  ...
  [_GHOTI] = LAYOUT(
    ...
    MI_D,   MI_G,  MI_C1,  MI_F1,     MI_As1, MI_Ds2,  MI_Gs2, MI_Cs3,  MI_Fs3, MI_B3,  MI_E4,   MI_A4,  MI_D5,   MI_G5,    MI_OCTD,              _______, _______, _______, _______,
      ...
      _______,   MO(_FUNC), _______, _______, _______,          _______,        _______, _______, _______,         _______, _______, _______,         _______,    _______
  ),
...
|____________|________|________|________|________|________|________|________|________|________|________|________|________|________||________||________|________|________|        |
  ...
  */
  ...
  [_FUNC] = LAYOUT(
    _______,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_BRID, KC_BRIU, KC_BSPC,    KC_MPLY,  _______, _______, _______, _______,
    TO(_BASE), TO(_GHOTI), TO(_PADS), _______, _______, _______, _______, _______, _______, _______, RGB_TOG, RGB_VAD, RGB_VAI, KC_DEL,      KC_VOLU,  _______, _______, _______, _______,
