...
*/
  ...
  [_PADS] = LAYOUT(
    ...
    _______,   MI_Gs, MI_A, MI_As, MI_B, _______, _______,      MI_C2, MI_Cs2, MI_D2, MI_Ds2, _______, _______, _______,  MI_OCTU,
      _______,   MI_E, MI_F, MI_Fs, MI_G, _______, _______,     MI_Gs1, MI_A1, MI_As1, MI_B1, _______, _______,         MI_OCTD,
      _______,     MI_C, MI_Cs, MI_D, MI_Ds, _______, _______, MI_E1, MI_F1, MI_Fs1, MI_G1,  _______,       _______, _______,
      _______,   _______, MO(_FUNC), _______, _______,          _______,        _______, _______, _______,         _______, _______, _______
  ),
...
*/
  ...
  [_FUNC] = LAYOUT(
    TO(_BASE),  TO(_MIDI),   TO(_PADS),   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,  _______,  _______,  KC_DEL,      _______,
    _______, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O,  KC_P, _______, _______, _______,              KC_VOLD,
      ...
      KC_LSFT,     KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, _______, _______, _______,       _______,           KC_UP, _______,
