  ...
  [_BASE] = LAYOUT(
    ...
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,      KC_PGUP,  KC_NUM,  KC_PSLS, KC_PAST, KC_PMNS,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,  KC_PGDN,  KC_P7,   KC_P8,   KC_P9,   KC_PPLS,
          ...
          KC_LCTL, MO(_FUNC), KC_LALT,  KC_LGUI,     KC_SPC,           KC_SPC,     KC_RCTL,   KC_RALT,   MO(1),         KC_LEFT, KC_DOWN, KC_RGHT,        KC_P0,      KC_PDOT
  ),



  [_GHOTI] = LAYOUT(
    MI_E, MI_A,  MI_D1,  MI_G1,   MI_C2,  MI_F2,  MI_As2, MI_Ds3, MI_Gs3,  MI_Cs4,  MI_Fs4, _______, _______, _______,             _______, _______, _______, _______, _______,
    MI_F, MI_As, MI_Ds1, MI_Gs1,  MI_Cs2, MI_Fs2, MI_B2,  MI_E3,  MI_A3,   MI_D4,   MI_G4, _______, _______, _______,    _______,          _______, _______, _______, _______,
    MI_Fs, MI_B,  MI_E1,  MI_A1,   MI_D2,   MI_G2, MI_C3,   MI_F3,  MI_As3, MI_Ds4,  MI_Gs4, _______, _______, _______, _______,    _______, _______, _______, _______,
      MI_G, MI_C1, MI_F1,  MI_As1,  MI_Ds2,  MI_Gs2, MI_Cs3, MI_Fs3,  MI_B3, MI_E4,  MI_A4, _______, _______,         _______,      _______, _______, _______,
      MI_Gs, MI_Cs1, MI_Fs1, MI_B1,  MI_E2,   MI_A2,  MI_D3,  MI_G3,   MI_C4, MI_F4, MI_As4,     _______,   MI_OCTU,         _______, _______, _______, _______,
      _______,   MO(_FUNC), _______, _______, _______,          _______,        _______, _______, _______,         _______, MI_OCTD, _______,         _______,    _______
  ),

  [_PADS] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,      _______,  _______, _______, _______, _______,
    _______, MI_C, MI_Cs,  MI_D, MI_Ds,  _______, _______,   MI_E1, MI_F1, MI_Fs1, MI_G1, _______, _______,_______,    _______,  _______, _______, _______, _______,
    _______,   MI_E, MI_F, MI_Fs, MI_G, _______, _______,      MI_Gs1, MI_A1, MI_As1, MI_B1, _______, _______, _______,  _______,  _______, _______, _______, _______,
      _______,   MI_Gs, MI_A, MI_As, MI_B, _______, _______,     MI_C2, MI_Cs2, MI_D2, MI_Ds2, _______, _______,         _______,  _______, _______, _______,
      _______,     MI_C1, MI_Cs1, MI_D1, MI_Ds1, _______, _______, MI_E2, MI_F2, MI_Fs2, MI_G2,  _______,       MI_OCTU,          _______, _______, _______, _______,
      _______,   MO(_FUNC), _______, _______, _______,          _______,        _______, _______, _______,         _______, MI_OCTD, _______,        _______,    _______
  ),
...
|____________|________|________|________|________|________|________|________|________|________|________|________|________|________||________||________|________|________|        |
  ...
  */
  ...
  [_FUNC] = LAYOUT(
    _______,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,    KC_MPLY,  _______, _______, _______, _______,
    TO(_BASE), TO(_GHOTI), TO(_PADS), _______, _______, _______, _______, _______, _______, _______, RGB_TOG, RGB_VAD, RGB_VAI, _______,      KC_VOLU,  _______, _______, _______, _______,
    ...
    KC_LCTL,   _______, KC_LALT, KC_LGUI, KC_SPC,          KC_SPC,        _______, _______, _______,           KC_LEFT, KC_DOWN, KC_RIGHT,         _______,    _______
  ),
};
